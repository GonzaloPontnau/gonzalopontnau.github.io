    ...
    'experience': {
      'es': {
        ...
        'abbIntern': {
          ...
          'description1': 'Contribuyo al diseño y desarrollo de soluciones de <strong>IA agéntica</strong> y recuperación de conocimiento empresarial, combinando orquestación multiagente, RAG/GraphRAG e inferencia local de modelos de lenguaje. Estas capacidades se reflejan en <strong>TenderCortex - Multi-Agent Intelligence</strong>, un proyecto existente del portfolio.',
      ...
      'en': {
        ...
        'abbIntern': {
          ...
          'description1': 'I contribute to the design and architecture of <strong>Agentic AI</strong> solutions and enterprise knowledge retrieval, combining multi-agent orchestration, RAG/GraphRAG, and local LLM inference. These capabilities are reflected in <strong>TenderCortex - Multi-Agent Intelligence</strong>, an existing portfolio project.',
