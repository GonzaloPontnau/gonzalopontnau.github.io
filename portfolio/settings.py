...
ALLOWED_HOSTS = ['*']  # En producción, específica los hosts permitidos
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR],  # Agregamos el directorio raíz para encontrar index.html
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Asegurar que CSRF esté activado
